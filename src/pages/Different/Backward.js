...
class Forwardh extends Component {
    ...
    forward1(x, h, degree) {
        switch (degree) {
            case 1:
                f = (this.func(x) - this.func(x-(1*h))) / h
                break;
            case 2:
                f = (this.func(x) - 2*this.func(x-(1*h)) + this.func(x-(2*h))) / Math.pow(h, 2)
                break;
            case 3:
                f = (this.func(x) - 3*this.func(x-(1*h)) + 3*this.func(x-(2*h)) - this.func(x-(3*h))) / Math.pow(h, 3)
                break;
            default:
                f = (this.func(x) - 4*this.func(x-(1*h)) + 6*this.func(x-(2*h)) - 4*this.func(x-(3*h)) + this.func(x-(4*h))) / Math.pow(h, 4) 
        }
                ...
                >  
                    ...
                    >
                        ...
                        {this.state.showOutputCard1 && 
                            <Content
                                style={{background: "white", borderRadius:"10px" , width:500}}
                            >
